...
public class black extends Item implements IFlowerComponent {

    public black() {
        setUnlocalizedName("mana_petal_black");
        setRegistryName("mana_petal_black");
        setCreativeTab(mxtweaks.creativeTab);
    }

    public void registerItemModel() {
        mxtweaks.proxy.registerItemRenderer(this, 0, "mana_petal_black");
    }
