...
public class pink extends Item implements IFlowerComponent {

    public pink() {
        setUnlocalizedName("mana_petal_pink");
        setRegistryName("mana_petal_pink");
        setCreativeTab(mxtweaks.creativeTab);
    }

    public void registerItemModel() {
        mxtweaks.proxy.registerItemRenderer(this, 0, "mana_petal_pink");
    }
