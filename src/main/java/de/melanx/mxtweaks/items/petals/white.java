...
public class white extends Item implements IFlowerComponent {

    public white() {
        setUnlocalizedName("mana_petal_white");
        setRegistryName("mana_petal_white");
        setCreativeTab(mxtweaks.creativeTab);
    }

    public void registerItemModel() {
        mxtweaks.proxy.registerItemRenderer(this, 0, "mana_petal_white");
    }
