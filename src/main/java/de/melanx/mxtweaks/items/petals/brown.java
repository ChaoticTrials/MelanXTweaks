...
public class brown extends Item implements IFlowerComponent {

    public brown() {
        setUnlocalizedName("mana_petal_brown");
        setRegistryName("mana_petal_brown");
        setCreativeTab(mxtweaks.creativeTab);
    }

    public void registerItemModel() {
        mxtweaks.proxy.registerItemRenderer(this, 0, "mana_petal_brown");
    }
